...
@Component({
  selector: 'signuppt',
  templateUrl: 'signuppt.page.html',
  styleUrls: ['signuppt.page.scss'],
})
export class SignupptPage {
  type: any;
  ...
  signUpWithEmail() {
    ...
    .then(user => {
      ...
      this.dataService.addUserPatient(this.signUpForm.value['name'], this.signUpForm.value['age'], this.signUpForm.value['gender'], this.signUpForm.value['email'], 'patient', this.userID)
